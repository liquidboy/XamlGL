...
export class GridRenderer implements IControlRenderer {
    ...
    private _elementChanged: EventDispatcher<GridRenderer, IEventArgs> =
    new EventDispatcher<GridRenderer, IEventArgs>();

    get GodRenderer(): Renderer { return this._godRenderer; }
    get Element(): FrameworkElement { return this._element; }
    get ElementChanged(): IEvent<GridRenderer, IEventArgs> { return this._elementChanged; }
