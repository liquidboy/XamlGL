...
export class SliderRenderer extends BaseRenderer implements IControlRenderer {
    ...
    InitializeResources(): void {
        ...
        ConsoleHelper.Log("SliderRenderer.InitializeResources");
    ...
    Clear(): void {
        ConsoleHelper.Log("SliderRenderer.Clear");
