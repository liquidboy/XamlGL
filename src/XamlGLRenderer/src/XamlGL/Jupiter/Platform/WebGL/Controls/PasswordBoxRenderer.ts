...
export class PasswordBoxRenderer extends BaseRenderer implements IControlRenderer {
    ...
    InitializeResources(): void {
        ...
        ConsoleHelper.Log("PasswordBoxRenderer.InitializeResources");
    ...
    Clear(): void {
        ConsoleHelper.Log("PasswordBoxRenderer.Clear");
