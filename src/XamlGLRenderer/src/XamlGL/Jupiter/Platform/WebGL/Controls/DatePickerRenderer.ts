...
export class DatePickerRenderer extends BaseRenderer implements IControlRenderer {
    ...
    InitializeResources(): void {
        ...
        ConsoleHelper.Log("DatePickerRenderer.InitializeResources");
    ...
    Clear(): void {
        ConsoleHelper.Log("DatePickerRenderer.Clear");
