...
export class DropdownListRenderer extends BaseRenderer implements IControlRenderer {
    ...
    InitializeResources(): void {
        ...
        ConsoleHelper.Log("DropdownListRenderer.InitializeResources");

        let dropdownListEl: DropdownList = <DropdownList>super.Element;
    ...
    Clear(): void {
        ConsoleHelper.Log("DropdownListRenderer.Clear");
